...
export function CreditPixModal({ open, onOpenChange, packageIndex, packageLabel, credits }: Props) {
  ...
  }, [open, pix, confirmed, expired, credits, onOpenChange, refreshPlan]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md backdrop-blur-xl bg-card/95">
        <DialogHeader>
          <DialogTitle>Pagar com PIX — {packageLabel}</DialogTitle>
          <DialogDescription>
            Após o pagamento, os créditos serão adicionados automaticamente em até 2 minutos.
          </DialogDescription>
        </DialogHeader>
        ...
        <AnimatePresence mode="wait">
          ...
          {confirmed && (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">+{credits} créditos adicionados à sua conta.</p>
            </motion.div>
          )}
